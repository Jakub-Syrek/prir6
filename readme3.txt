...
//TODO: implementacja hashsetu lub treesetu
//TODO: wait & notify
...
public class MotionDetectionSystem implements MotionDetectionSystemInterface {
    ...
    private class ResultWrapper implements Runnable{
        ...
        public void run() {
            ...
            if(((ResultWrapper)this).frameNumber == 0){
                Runnable next = null;
                next = executor2.getQueue().stream().filter(x -> ((ResultReturnerCallable)x).frameNumber == returnedCounter.intValue() + 1).findFirst().orElse(null);
...
//    if (cores <= thPoolExecutor.getMaximumPoolSize()) {
//        thPoolExecutor.setCorePoolSize(cores);
//        thPoolExecutor.setMaximumPoolSize(cores);
//    } else {
//        thPoolExecutor.setMaximumPoolSize(cores);
//        thPoolExecutor.setCorePoolSize(cores);
//    }
    ...
    public void setThreads(int threads) {
        ...
        System.out.println("[INFO] " + threads);
...
//            };
        ...
        System.out.println("[INFO1] " + threads);
    }
